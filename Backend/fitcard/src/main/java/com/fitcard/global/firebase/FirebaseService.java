...
public interface FirebaseService {
    ...
    List<Map<String, String>> getUsersWithCardInfo(String cardCompanyName, String cardName, boolean isBC, boolean isCredit, boolean isPersonal, boolean isCategory);
