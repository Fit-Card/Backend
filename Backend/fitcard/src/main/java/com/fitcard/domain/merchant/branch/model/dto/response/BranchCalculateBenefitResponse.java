...
public class BranchCalculateBenefitResponse {
    ...
    @Schema(description = "혜택 금액", example = "500")
    private Double benefitValue;

    public static BranchCalculateBenefitResponse of(Integer cardVersionId, String cardName, String cardImg, String merchantName, String benefitDescription, Double benefitResult){
        return new BranchCalculateBenefitResponse(cardVersionId, cardName, cardImg,merchantName, benefitDescription,benefitResult);
    }
}
